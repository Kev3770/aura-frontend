    ...
    <footer className="bg-primary text-white mt-auto">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-xl font-display uppercase mb-4">AURA</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Ropa masculina premium. Estilo, calidad y confianza en cada prenda.
            </p>
          </div>

          {/* Columna 2: Navegación */}
          <div>
            <h4 className="text-sm font-display uppercase mb-4 tracking-wider">
              Navegación
            </h4>
